<template>
    <div class="sidebar_container">
        <div class="nav__start_region">
            <div class="wrap_logo">
                <router-link to="/">
                    <svg aria-label="Instagram" class="ig_logo_web x1lliihq x1n2onr6 x5n08af" fill="currentColor"
                    ...
                    <svg aria-label="Instagram" class="ig_logo_mobile x1lliihq x1n2onr6 x5n08af" fill="currentColor"
        ...
        <div class="nav__center_region">
            <ul class="list_nav_page">
                <li class="nav_item">
                    <router-link to="/">
                        <div class="wrap_nav_icon">
                            <svg v-if="!isPageHome" aria-label="Home" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
                            ...
                            <svg v-else-if="isPageHome" aria-label="Home" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
                                role="img" viewBox="0 0 24 24" width="24">
                                <title>Home</title>
                                <path
                        ...
                        <div class="wrap_title">Home</div>
                    </router-link>
                </li>
                <li class="nav_item">
                    <router-link to="/search">
                        <div class="wrap_nav_icon">
                            <svg aria-label="Cerca" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
                                role="img" viewBox="0 0 24 24" width="24">
                                <title>Cerca</title>
                        ...
                        <div class="wrap_title">Cerca</div>
                    </router-link>
                </li>
                <li class="nav_item">
                    <router-link to="/explore">
                        <div class="wrap_nav_icon">
                            <svg aria-label="Esplora" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
                                role="img" viewBox="0 0 24 24" width="24">
                                <title>Esplora</title>
                                <polygon fill="none"
                        ...
                        <div class="wrap_title">Eslora</div>
                    </router-link>
                </li>
                <li class="nav_item">
                    <router-link to="/reels">
                        ...
                        <div class="wrap_title">Reels</div>
                    </router-link>
                </li>
                <li class="nav_item">
                    <router-link to="/messages">
                        <div class="wrap_nav_icon">
                            <svg aria-label="Direct" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
                                role="img" viewBox="0 0 24 24" width="24">
                                <title>Direct</title>
                        ...
                        <div class="wrap_title">Messaggi</div>
                    </router-link>
                </li>
                <li class="nav_item">
                    <router-link to="/notify">
                        ...
                        <div class="wrap_title">Notifiche</div>
                    </router-link>
                </li>
                <li class="nav_item">
                    <router-link to="/create">
                        <div class="wrap_nav_icon">
                            <svg aria-label="Nuovo post" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
                                role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <div class="wrap_title">Crea</div>
                    </router-link>
                </li>
                <li class="nav_item">
                    <router-link to="/profile">
                        <div class="wrap_nav_profile_image">
                            <img class="img_profile" src="/_resources/imgs/profile_placeholder.jpg"
                                alt="profile image placeholder">
                            <div class="badge_notify" v-if="data.badgeNotify">
                                <span class="label_notify">{{ data.badgeLabel }}</span>
                            </div>
                        </div>
                        <div class="wrap_title">Profilo</div>
                    </router-link>
                </li>
            </ul>
        </div>
...
.nav_item:hover .wrap_nav_icon {
    transform: scale(1.05);
}

.nav_item:active .wrap_nav_icon {
...
.nav_item .router-link-active .wrap_title {
    font-weight: 900;
}

.wrap_nav_profile_image {
    position: relative;
...
.nav_item:hover .wrap_nav_profile_image {
    transform: scale(1.05);
}

.wrap_nav_profile_image .img_profile {
    height: 100%;
    width: 100%;
    object-fit: cover;
    border-radius: 50%;
